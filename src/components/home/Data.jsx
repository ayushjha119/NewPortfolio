...
const Data = () => {
  ...
  return (
    <div className="home__data">
      <p>
        <span className="introduction">◢◤◥◣ ┣┫Ё┗└_Ο, my name is</span>
      </p>
      ...
      <h3 className="home__subtitle">
        I'm a{" "}
        <span style={{ whiteSpace: "pre" }} className="typed" ref={el}></span>
        {/* <Typewriter
                    options={{
                        autoStart: true,
                        loop: true,
      ...
      <p className="home__description">
        {" "}
        I am based in Kolkata and bring a strong sense of passion and dedication
        to my work.
      </p>
